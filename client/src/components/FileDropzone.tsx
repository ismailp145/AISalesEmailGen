  ...
  return (
    <div
      className={cn(
        ...
        !isDragOver && !error && !selectedFile && "border-border"
      )}
    >
      <div
        onDrop={handleDrop}
        ...
        {selectedFile ? (
          ...
          <>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Headers: first_name, last_name, title, company, email, linkedin_url, notes
              </p>
            </div>
          </>
        )}
        {error && (
          <p className="text-xs text-destructive" data-testid="text-file-error">
            {error}
          </p>
        )}
      </div>
